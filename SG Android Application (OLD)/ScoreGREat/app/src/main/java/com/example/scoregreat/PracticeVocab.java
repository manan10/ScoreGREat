...
public class PracticeVocab extends AppCompatActivity {
    ...
    public static final String NAME = "QUES_NO";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_practice_vocab);
        ...
        cl.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(PracticeVocab.this, "Cannot be used for Vocabulary section", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        f.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                editor.putInt(NO,1);
                editor.apply();
                Intent i = new Intent(PracticeVocab.this,UserHome.class);
                startActivity(i);
            }
        });
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (flag == 0)
                    Toast.makeText(PracticeVocab.this, "Select at least one option", Toast.LENGTH_SHORT).show();
                else  {
                    for(k=0;k<5;k++){
                        if(a[k].isChecked()){
                            usi = k;
    ...
    public String[] ques(int i, String q[], DatabaseReference md) {
        md.child("questions").child("vocabs").child(q[i]).child("que").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
        ...
        for (int j = 0; j < 5; j++) {
            final int finalJ = j;
            md.child("questions").child("vocabs").child(q[i]).child("op").child(String.valueOf(j)).addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
        ...
        md.child("questions").child("vocabs").child(q[i]).child("ans").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
