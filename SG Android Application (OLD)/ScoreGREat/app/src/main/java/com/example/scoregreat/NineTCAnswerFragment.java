...
public class NineTCAnswerFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rv = inflater.inflate(R.layout.activity_nine_tcanswer_fragment, container, false);
        String answer1,yourans1,answer2,yourans2,answer3,yourans3;
        ...
        try{
            ...
            rg3 = getActivity().findViewById(R.id.rg3);
            ...
            answer3 = this.getArguments().getString("answer3");
            yourans3 = this.getArguments().getString("userAns3");
            i = this.getArguments().getInt("que_no");
            j = this.getArguments().getInt("len");

            que.setText(this.getArguments().getString("que"));
            cans.setText("Correct Answers: " + this.getArguments().getString("answer1") + ", " +  this.getArguments().getString("answer2") + ", " +  this.getArguments().getString("answer3"));
            uans.setText("Your Answers: " + this.getArguments().getString("userAns1") + ", " + this.getArguments().getString("userAns2") + ", " +  this.getArguments().getString("userAns3"));
            check.setBackgroundColor(Color.rgb(255, 179, 102));

            if(answer1.equals(yourans1) && answer2.equals(yourans2) && answer3.equals(yourans3)){
