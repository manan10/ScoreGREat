...
public class Practice_Quant extends AppCompatActivity {
    TextView que;
    ...
    public static final String SPNAME = "QUES_NO";
    public static final String QNO = "no";

    @SuppressLint({"WrongConstant","RestrictedAPI"})
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_practice__quant);

        this.getSupportActionBar().hide();
        final Toolbar mActionBarToolbar = findViewById(R.id.toolbar2);

        mActionBarToolbar.setTitle("Quants Practice");
        ...
        f.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                editor.putInt(QNO,1);
                editor.apply();
                Intent intent = new Intent(Practice_Quant.this,UserHome.class);
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(flag==0)
                    Toast.makeText(Practice_Quant.this, "Select Atleast one option", Toast.LENGTH_SHORT).show();
                else{
                    for(k=0;k<5;k++){
                        if(a[k].isChecked()){
                            usi = k;
    ...
    public String[] ques(int i, String q[], DatabaseReference md) {
        md.child("questions").child("quants").child("mcq").child(q[i]).child("que").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
        ...
        for (int j = 0; j < 5; j++) {
            final int finalJ = j;
            md.child("questions").child("quants").child("mcq").child(q[i]).child("op").child(String.valueOf(j)).addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
        ...
        md.child("questions").child("quants").child("mcq").child(q[i]).child("ans").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
