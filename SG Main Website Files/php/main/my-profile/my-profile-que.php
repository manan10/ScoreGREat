...
<html lang="en">
    <head>
        ...
        <title>Score GREat | My Questions</title>
        <meta charset="utf-8">
                ...
                echo "<div class='card shadow-lg mb-2 text-left review-card'>
                        <div class='card-header bg-dark' style='color:white'>
                            <div class='float-right'>
                                <button class='btn btn-sm btn-outline-secondary' id='edit'><i class='fas fa-pen' style='color:white'></i></button>
                                <a href='my-profile-que-db.php' class='btn btn-sm btn-outline-secondary'><i class='fas fa-trash-alt' style='color:white'></i></a>
                            </div>
                            <div class='d-flex'>
                        ...
                        <div class='card-body' id='pd-que'>
                            <span>" . nl2br($row['que']) . "</span>
                            <span class='d-none'> 
                                <form action='my-profile-que-db.php' method='POST'>
                                    <div class='form-group'>
                                        <textarea class='form-control w-100' name='e-que'>" . nl2br($row['que']) . "</textarea> 
                                    </div>
                                    <button type='submit' class='btn form-control mt-3' style='background-color: black; color: white'>Update</button>
                                </form>
                            </span>
                        </div>
                        <div class='card-footer' id='pd-ans'>
                            <form action='my-profile-que-db.php' method='POST'>";
                        if($row['answers'] != null) {
    ...
    <script>
        $(document).ready(function(){
            ...
            $("#edit").click(function(){
                $("#pd-que span").eq(0).addClass('d-none');
                $("#pd-que span").eq(1).removeClass("d-none");
                $("#pd-ans").addClass("d-none");
            });
